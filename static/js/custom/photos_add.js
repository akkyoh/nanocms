...
var uploader = new plupload.Uploader({
    ...
    container : 'container',
    url : '/modules/photos_add/?category='+$('#filelist').attr('data-category'),
    filters : [
    {
        title : "Image files", 
...
$('#page_photos_add').bind('pageshow', function () {
...
$('#page_photos_add').bind('pagehide', function () {
    $('#page_photos_add').remove();
});

$('#page_photos_add').on('click', '#clean', function(){
