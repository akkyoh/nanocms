<? 
    head('Гостевая книга', NULL, NULL, 'http://'.$_SERVER['HTTP_HOST'].'/'.$_GET['page'].'/'); 
?>
...
<div data-role="content">
    ...
    <p id="guestbook" data-e="<?=get_elements()?>"></p>
    
    <ul data-role="listview" data-inset="true">
        <li>
            <form id="guestbook_send">
...
<script src="/static/js/custom/guestbook.js"></script>
