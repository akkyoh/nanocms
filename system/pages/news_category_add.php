<? 
    ...
    else
    {
        ...
        $data_category = news::data_category($category);
...
<script src="/static/js/validation/news_category_add.js"></script>
<script src="/static/js/custom/news_category_add.js"></script>
