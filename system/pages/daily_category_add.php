<? 
    ...
    else
    {
        ...
        $data_category = daily::data_category($category);
...
<script src="/static/js/validation/daily_category_add.js"></script>
<script src="/static/js/custom/daily_category_add.js"></script>
