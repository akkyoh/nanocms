<? 
    ...
    head('Дневники', NULL, NULL, 'http://'.$_SERVER['HTTP_HOST'].'/'.$_GET['page'].'/'); 
    
    if(isset($_GET['user']))
        $user_notes = $user_category = intval($_GET['user']);
    else{
        $user_notes = 0;
...
<div data-role="content">
    ...
    <p id="daily_last" data-user="<?=$user_notes?>" data-e="<?=get_elements()?>"></p>
    ...
    <ul data-role="listview" data-inset="true" data-divider-theme="c" id="management">
        ...
        <li data-icon="star"><a href="/daily_draft/">Черновики</a></li>
        <li data-icon="gear"><a href="/daily_category_add/">Добавить категорию</a></li>
...
<script src="/static/js/custom/daily.js"></script>
