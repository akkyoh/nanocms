 ...
 */
  ...
  protected function SmtpSend($header, $body) {
    ...
    if (count($bad_rcpt) > 0 ) { //Create error message for any bad addresses
      ...
      throw new phpmailerException('Ошибка при отправке уведомоления пользователю на почтовый ящик.<br>');
    }
    ...
    if(isset($images[2])) {
      foreach($images[2] as $i => $url) {
        ...
        if (!preg_match('#^[A-z]+://#',$url)) {
          ...
          if ( strlen($basedir) > 1 && substr($basedir,-1) != '/index.php') { $basedir .= '/index.php'; }
          if ( strlen($directory) > 1 && substr($directory,-1) != '/index.php') { $directory .= '/index.php'; }
